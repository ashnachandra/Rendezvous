...
<body onload="allowCalendar()">
	...
	<div id="login">
		...
		<div class="guest-div">
			...
			<%=groupObj.setupGroup()%>
			&nbsp;<button type="button" class ="btn btn-primary group-btn" onclick="onGuess()">View Group as Guest</button>
		</div>
	</div>
	...
	<script>
		...
		function onSignIn(googleUser) {
			...
			if (xhttp.responseText.trim().length > 0) {
				...
				window.location.href = "https://accounts.google.com/o/oauth2/v2/auth?response_type=code&client_id=__.apps.googleusercontent.com&redirect_uri=http:\/\/localhost:8080/csci201_finalprojectWeb/index.jsp&scope=https:\/\/www.googleapis.com/auth/calendar.readonly&state=https:\/\/www.googleapis.com/auth/calendar.readonly&access_type=offline";
